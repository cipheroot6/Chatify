...
export function createVerificationEmailTemplate(name, verificationURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #5B86E5;"><strong>Hello ${name},</strong></p>
      <p>Thank you for signing up for Chatify. Please click the button below to verify your email address. This link will expire in 24 hours.</p>
      
      <div style="text-align: center; margin: 30px 0;">
        <a href="${verificationURL}" style="background: linear-gradient(to right, #36D1DC, #5B86E5); color: white; text-decoration: none; padding: 12px 30px; border-radius: 50px; font-weight: 500; display: inline-block;">Verify Email</a>
      </div>
      
      <p style="margin-bottom: 5px;">Or copy and paste this link into your browser:</p>
      <p style="margin-top: 0; word-break: break-all; color: #5B86E5;">${verificationURL}</p>
      
      <p style="margin-top: 25px; margin-bottom: 0;">If you didn't create an account, ignore this email.</p>
...
export function createPasswordResetEmailTemplate(name, resetURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #5B86E5;"><strong>Hello ${name},</strong></p>
      <p>We received a request to reset your Chatify password. Please click the button below to choose a new password. This link will expire in 1 hour.</p>
      ...
      <p style="margin-bottom: 5px;">Or copy and paste this link into your browser:</p>
      <p style="margin-top: 0; word-break: break-all; color: #5B86E5;">${resetURL}</p>
      
      <p style="margin-top: 25px; margin-bottom: 0;">If you didn't request a password reset, you can safely ignore this email.</p>
